...
* address review comments - deploy regex, release pnpm install, ci fetch-depth, pre-push newline ([a9408fd](https://github.com/Dahgoth/kompmaster-server/commit/a9408fd56f116a57eddd43c721a560023c0c9a75))
...
* **ci:** add fetch-depth: 0 to versions job checkout ([aae1c2c](https://github.com/Dahgoth/kompmaster-server/commit/aae1c2cbc1454d09c9c6b660f9ccc03915184e80))
...
* **ci:** checkout PR head directly for versions job to avoid merge conflict ([2659172](https://github.com/Dahgoth/kompmaster-server/commit/26591729960ca424d0edaa8103e4f42f9d8c1c63))
...
* **ci:** remove fetch-depth from versions job; fix pre-commit trailing newline ([053bef9](https://github.com/Dahgoth/kompmaster-server/commit/053bef9f7f97a2b6660bfae352967b77f6369c2d))
...
* **ci:** restore version sync; fix deploy trigger; add pre-commit prettier ([#71](https://github.com/Dahgoth/kompmaster-server/issues/71)) ([9750946](https://github.com/Dahgoth/kompmaster-server/commit/97509462a89cc83df9882109720504e09d67b8e6))
* **ci:** run versions job only on push to main ([6c9e4b6](https://github.com/Dahgoth/kompmaster-server/commit/6c9e4b6a7a7b66ef9d9aad4e371c9e3968df1dee))
* **ci:** run versions job only on push, not PRs ([7ef2ac3](https://github.com/Dahgoth/kompmaster-server/commit/7ef2ac3a546a594313cb5c1c5f8d0589fa6e0318))
...
* **ci:** use explicit PR head SHA for versions job checkout ([cb20a85](https://github.com/Dahgoth/kompmaster-server/commit/cb20a85e448b7755cb6d798c63ccdc9bb22942ee))
...
* **release:** correct manifest keys to match config (backend/frontend) ([#67](https://github.com/Dahgoth/kompmaster-server/issues/67)) ([ebf7e66](https://github.com/Dahgoth/kompmaster-server/commit/ebf7e6671325b646c7a3ce7d35c3e966fb3ebecd))
* **release:** correct manifest keys to match config (use backend/frontend instead of kompmaster-*) ([76a8e95](https://github.com/Dahgoth/kompmaster-server/commit/76a8e95e5361a1eef8c79c4d91b2f039ce145ac5))
...
* **release:** single root package config; single CHANGELOG.md ([ef9c2fa](https://github.com/Dahgoth/kompmaster-server/commit/ef9c2fac278281c4c581735c1f975ebb22b36f8a))
* **release:** single root package config; single CHANGELOG.md ([#69](https://github.com/Dahgoth/kompmaster-server/issues/69)) ([7a93335](https://github.com/Dahgoth/kompmaster-server/commit/7a93335de739617ecc0b18770c5caeaca747b11d))
